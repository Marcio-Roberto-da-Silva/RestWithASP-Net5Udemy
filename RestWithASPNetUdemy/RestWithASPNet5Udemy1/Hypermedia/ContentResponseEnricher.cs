...
namespace RestWithASPNet5Udemy1.Hypermedia {
    public abstract class ContentResponseEnricher<T> : IResponseEnricher where T : Abstract.ISupportsHyperMedia 
        {
        ...
        protected abstract void EnrichModel(T content, IUrlHelper urlHelper);
